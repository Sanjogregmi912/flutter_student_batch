...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 4383352026974427322),
      name: 'Batch',
      lastPropertyId: const IdUid(2, 4898781424586047629),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 2651625615009735838),
            name: 'batchId',
            type: 6,
            flags: 129),
        ModelProperty(
            id: const IdUid(2, 4898781424586047629),
            name: 'batchName',
            type: 9,
            flags: 0)
      ],
  ...
  ModelEntity(
      id: const IdUid(2, 1927688744328598249),
      name: 'Student',
      lastPropertyId: const IdUid(6, 150705397780725943),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 8824993590360813792),
            name: 'stdId',
            type: 6,
            flags: 129),
        ModelProperty(
            id: const IdUid(2, 3322849496565047026),
            name: 'fname',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 2976523835217625930),
            name: 'lname',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 5228362880929409508),
            name: 'username',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(5, 7148826156779553549),
            name: 'password',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(6, 150705397780725943),
            name: 'batchId',
            type: 11,
            flags: 520,
            indexId: const IdUid(1, 7010051168080542148),
            relationTarget: 'Batch')
      ],
      relations: <ModelRelation>[
        ModelRelation(
            id: const IdUid(1, 6459603296005205272),
            name: 'course',
            targetId: const IdUid(3, 885028805110342983))
      ],
      backlinks: <ModelBacklink>[]),
  ModelEntity(
      id: const IdUid(3, 885028805110342983),
      name: 'Course',
      lastPropertyId: const IdUid(2, 23984276957472489),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            ...
            flags: 129),
        ModelProperty(
            id: const IdUid(2, 23984276957472489),
            name: 'courseName',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(3, 885028805110342983),
      lastIndexId: const IdUid(1, 7010051168080542148),
      lastRelationId: const IdUid(1, 6459603296005205272),
